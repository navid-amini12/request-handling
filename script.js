...
sayHelloButton.addEventListener('mouseover', () => {
    sayHelloButton.color = "purple";
    sayHelloButton.backgroundColor = "green";
...
sayHelloButton.addEventListener('mouseout',() => {
    sayHelloButton.backgroundColor = "red";
    sayHelloButton.color = 'red';
...
const repeatMyParam = () => {
    ...
    .then(res => res.data)
    let elem = document.getElementById('repeat-text');
